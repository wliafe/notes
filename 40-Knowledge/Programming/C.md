...
1. [[#函数|C 函数基础]]
2. [[#字符串和字符串函数|C 字符串与字符串函数]]
3. [[#文件输入输出函数|C 文件输入输出函数]]
4. [[#结构体|C 结构体]]
5. [[#Linux I/O|Linux IO 基础]]
6. [[#原子操作和竞争条件|Linux IO 控制与文件描述符]]
7. [[#在文件特定偏移量处的I/O：pread()和pwrite()|Linux IO 高级操作]]
8. [[#Linux进程|Linux 进程基础]]
...
![[99-Assets/Legacy/语言/C/2.png]]

![[99-Assets/Legacy/语言/C/3.png]]
