...
---
> [!info] 导航
> [[40-Knowledge/Systems/Systems|返回系统索引]]
...
![[99-Assets/Legacy/系统/ESXI/6.png]]

vi搜索MEM_MIN_SIZE

第一次搜索命中结果应该定位到如下图光标位置。

![[99-Assets/Legacy/系统/ESXI/7.png]]

第一次命中结果

我们要修改的就在下方，使用光标定位到下面或者在搜索时按下n键去找第二次命中应该就是了。

![[99-Assets/Legacy/系统/ESXI/8.png]]

需要修改的部分

定位光标到第一个4后面，按i进入编辑模式，退格删除4，修改为2。

![[99-Assets/Legacy/系统/ESXI/9.png]]
...
![[99-Assets/Legacy/系统/ESXI/10.png]]

回到安装界面

一系列操作后，原来的内存检查错误界面不会出现了，出现了擦除安装介质的对话框，F11继续。

![[99-Assets/Legacy/系统/ESXI/11.png]]

没有再次出现内存检查错误

然后就是等进度条啦。

![[99-Assets/Legacy/系统/ESXI/12.png]]

开始等进度条

安装结束，提示拔下ESXI安装盘，比如U盘，然后回车重启。

![[99-Assets/Legacy/系统/ESXI/13.png]]

安装完成

ESXI重启加载完毕后。

![[99-Assets/Legacy/系统/ESXI/14.png]]

重启完毕

访问ESXI网页控制台，3.75GB内存正常使用。

![[99-Assets/Legacy/系统/ESXI/15.png]]
...
![[99-Assets/Legacy/系统/ESXI/16.png]]

在最后加上autoPartitionOSDataSize参数即可定制虚拟闪存大小。

![[99-Assets/Legacy/系统/ESXI/17.png]]
...
![[99-Assets/Legacy/系统/ESXI/18.png]]
