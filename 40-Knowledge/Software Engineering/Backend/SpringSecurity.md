...
---
> [!info] 导航
> [[40-Knowledge/Software Engineering/Backend/Backend|返回后端索引]]

SpringSecurity是Spring安全框架的一种，这里是[哔哩哔哩视频](https://www.bilibili.com/video/BV1mm4y1X7Hc/)，以下内容是对SpringSecurity补充。

## 章节目录

1. [[#Spring Security替换WebSecurityConfigurerAdapter(Deprecated)的方法|Spring Security 无适配器配置]]
2. [[#Spring Security JWT（JSON Web Token）without WebSecurityConfigurerAdapter|Spring Security JWT 配置]]
3. [[#SpringSecurity邮箱验证码登录配置方式|邮箱验证码原理]]
4. [[#开发邮箱验证码接口|邮箱验证码发送接口]]
5. [[#修改ValidateCodeController|邮箱验证码控制器与前端]]
6. [[#重构代码（一）|邮箱验证码第一次重构]]
7. [[#校验邮箱验证码并登录|邮箱登录 AuthenticationToken]]
8. [[#编写EmailAuthenticationFilter|邮箱登录 AuthenticationFilter]]
9. [[#编写EmailCodeAuthenticationProvider|邮箱登录 AuthenticationProvider]]
10. [[#编写EmailCodeFilter|邮箱验证码过滤器]]
11. [[#编写配置类EmailCodeAuthenticationSecurityConfig|邮箱登录安全配置]]
12. [[#重构代码（二）|邮箱验证码第二次重构]]
...
![[99-Assets/Legacy/后端/SpringSecurity/1.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/2.png]]

![[99-Assets/Legacy/后端/SpringSecurity/3.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/4.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/5.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/6.png]]

前端代码bug不深究

![[99-Assets/Legacy/后端/SpringSecurity/7.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/8.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/13.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/14.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/15.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/16.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/17.png]]

![[99-Assets/Legacy/后端/SpringSecurity/18.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/19.png]]

![[99-Assets/Legacy/后端/SpringSecurity/20.png]]

随便乱输入

![[99-Assets/Legacy/后端/SpringSecurity/21.png]]

![[99-Assets/Legacy/后端/SpringSecurity/22.png]]

输入正确验证码

![[99-Assets/Legacy/后端/SpringSecurity/23.png]]

![[99-Assets/Legacy/后端/SpringSecurity/24.png]]

等待60s（验证码过期）

![[99-Assets/Legacy/后端/SpringSecurity/26.png]]
...
![[99-Assets/Legacy/后端/SpringSecurity/27.png]]

图形和短信校验码的校验过滤器（validateFilter）合并为一个。

![[99-Assets/Legacy/后端/SpringSecurity/28.png]]

![[99-Assets/Legacy/后端/SpringSecurity/29.png]]

![[99-Assets/Legacy/后端/SpringSecurity/30.png]]

![[99-Assets/Legacy/后端/SpringSecurity/31.png]]

![[99-Assets/Legacy/后端/SpringSecurity/32.png]]

![[99-Assets/Legacy/后端/SpringSecurity/33.png]]

![[99-Assets/Legacy/后端/SpringSecurity/34.png]]

![[99-Assets/Legacy/后端/SpringSecurity/35.png]]

![[99-Assets/Legacy/后端/SpringSecurity/36.png]]

![[99-Assets/Legacy/后端/SpringSecurity/37.png]]
