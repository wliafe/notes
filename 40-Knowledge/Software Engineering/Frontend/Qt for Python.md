...
---
> [!info] 导航
> [[40-Knowledge/Software Engineering/Frontend/Frontend|返回前端索引]]
...
1. [[#Qt for Python环境搭建|Qt for Python 环境搭建]]
2. [[#Qt打包|Qt for Python 打包]]
3. [[#Qt使用GUI实时显示logging信息|Qt GUI 实时显示日志]]
...
我的Python环境主要依赖于uv，有关uv的详细内容可以参考我的博客[[uv]]
...
![[99-Assets/Legacy/前端/Qt for Python/1.png]]
...
![[99-Assets/Legacy/前端/Qt for Python/2.png]]
