...
![[99-Assets/Legacy/博客/NexT主题/1.png]]
...
![[99-Assets/Legacy/博客/NexT主题/2.png]]

选择`Latest release`，点击`Source code (zip)`下载。

![[99-Assets/Legacy/博客/NexT主题/3.png]]

如果没有`Releases`，就只能选择`Code`，点击`Download ZIP`下载。

![[99-Assets/Legacy/博客/NexT主题/4.png]]

下载完成后，解压出来一个文件夹，改名为next，放到themes文件夹下，如下图所示。

![[99-Assets/Legacy/博客/NexT主题/5.png]]
...
![[99-Assets/Legacy/博客/NexT主题/6.png]]
