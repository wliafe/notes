...
---
> [!info] 导航
> [[40-Knowledge/Software Engineering/Publishing/Publishing|返回博客索引]]
...
- [[Nodejs]]：JavaScript运行环境，用于运行Hexo。
- [Hexo](https://hexo.io/zh-cn/)：博客框架，用于将Markdown文件转换为静态HTML文件。

## 创建Git仓库

按照我的仓库体系创建blog仓库（我的博客仓库名），我的仓库体系详细内容请看我的[[Git]]这篇博客。
...
![[99-Assets/Legacy/博客/Hexo博客搭建/3.png]]
...
![[99-Assets/Legacy/博客/Hexo博客搭建/4.png]]

反向代理的配置这么填写

![[99-Assets/Legacy/博客/Hexo博客搭建/5.png]]
