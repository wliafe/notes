...
---
> [!info] 导航
> [[40-Knowledge/Deep Learning/Deep Learning|返回机器学习索引]]
...
1. [[#机器学习基础|深度学习资源与 Python 环境]]
2. [[#PyTorch环境搭建|PyTorch 版本与镜像]]
3. [[#安装命令|PyTorch CPU 与 cu128 安装]]
4. [[#cu126|PyTorch cu126 与 cu124 安装]]
5. [[#cu121|PyTorch cu121 安装]]
6. [[#cu118|PyTorch cu118 安装]]
7. [[#cu117|PyTorch cu117 至 cu113 安装]]
8. [[#cu111|PyTorch cu111 与 cu102 安装]]
9. [[#自选安装|PyTorch 自选版本安装]]
10. [[#Tensorflow环境搭建|TensorFlow 与本地 CUDA 环境]]
...
![[99-Assets/Legacy/机器学习/深度学习/1.png]]
