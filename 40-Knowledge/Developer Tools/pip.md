...
1. [[#pip常用命令|pip 常用命令与镜像]]
2. [[#创建一个库并发布到PyPI|发布 Python 库到 PyPI]]
3. [[#给PyPI项目添加文档|使用 Sphinx 编写项目文档]]
4. [[#sphinx_rtd_theme主题|Sphinx 主题与 Read the Docs]]
...
按照[[GitHub]]中的仓库管理体系创建仓库，并将项目clone到本地。
...
![[99-Assets/Legacy/工具/pip/1.png]]

添加GitHub Trusted Publisher。

![[99-Assets/Legacy/工具/pip/2.png]]
...
![[99-Assets/Legacy/工具/pip/3.png]]

找到API tokens

![[99-Assets/Legacy/工具/pip/4.png]]

按要求填写表单，生成token。

![[99-Assets/Legacy/工具/pip/5.png]]

### 将Token添加到GitHub Actions

在GitHub仓库中，选择Settings，选择Secrets and variables，选择Actions，点击New repository secret。

![[99-Assets/Legacy/工具/pip/6.png]]

填写从PyPI账号获取的token。

![[99-Assets/Legacy/工具/pip/7.png]]
