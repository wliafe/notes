...
---
> [!info] 导航
> [[40-Knowledge/Cybersecurity/Cybersecurity|返回安全索引]]
...
![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/1.png]]

![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/2.png]]

发现缺少两个dll文件,没关系，网上搜索直接下载，放入与exe文件同一个文件夹中。之后程序就能运行了：

![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/3.png]]

通过peid检查文件信息，包括文件是否加壳，文件是32位还是64位。

![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/4.png]]

发现是未加壳的32位文件，放入ida中。F5找到main函数：

![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/5.png]]

能知道str2的内容。需要知道str1的内容，显然str1和v10有关，而v10就是flag，发现sub_411294这个函数比较重要。点开后：

![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/6.png]]
...
![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/7.png]]
...
![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/8.png]]

![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/9.png]]
...
![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/10.png]]
...
![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/11.png]]

将区段名的R都改为U，这样就能用upx工具脱壳了。

脱壳后的文件放入ida中：

![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/12.png]]

通过shift+F12获取字符串

![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/13.png]]

发现you are right  you are wrong

点击跳转到字符串位置，向上翻找到：

![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/14.png]]

选定后按d 和p后就可以按F5

获得函数：

![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/15.png]]

![[99-Assets/Legacy/安全/第二届西安邮电大学网络安全大赛(部分re)/16.png]]
